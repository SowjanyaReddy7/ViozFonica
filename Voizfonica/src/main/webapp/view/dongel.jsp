...
<title>Dongel</title>
<link rel="stylesheet" href="dongelcss.css">
<style >
.pricing_plan{
	width: 500px;
	border-radius: 25px;
...
<div >
    <ul class="ullist">
      ...
      <li class="navlist">
        <a class="alist" href="${pageContext.request.contextPath}/view/dongel.jsp">Dongel</a>
      </li>
      <li class="navlist">
...
<section class="pricing_plan">
		...
		<a href="${pageContext.request.contextPath}/view/paymentdongel.jsp" class="pricing_plan_button">Purchase</a>
	...
	<section class="pricing_plan">
		...
		<p class="pricing_plan_txt"> VALIDITY: 28 days</p>
		<p class="pricing_plan_txt">Data: 120 GB/Month</p>
		<a href="${pageContext.request.contextPath}/view/paymentdongel.jsp" class="pricing_plan_button">Purchase</a>
		<p class="pricing_plan_txt1">Additional 2199 &#x20b9; for Dongel</p>
		</div>
		<div class="pricing_plan_descrp">
