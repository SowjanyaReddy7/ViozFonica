...
<title>Prepaid</title>
<link rel="stylesheet" href="prepaidcss.css">
<style>
.pricing_plan{
	width: 300px;
	border-radius: 25px;
...
<section class="pricing_plan">
		<div class="pricing_plan_header">
			<h1 class="pricing_plan_title">Basic Plan 1GB</h1>
			
		</div>
		
		<div class="pricing_plan_action">
		<p class="pricing_plan_cost">PLAN: &#x20b9; 159</p>
		<p class="pricing_plan_txt"> VALIDITY: 28 days</p>
		<p class="pricing_plan_txt">Data: 1GB/day</p>
	<a href="${pageContext.request.contextPath}/view/paymentprepaid.jsp" class="pricing_plan_button">Purchase</a>
		</div>
		<div class="pricing_plan_descrp">
			<ul class="pricing_plan_list">
				<li class="pricing_plan_feat">voice: unlimited</li>
	...
	<section class="pricing_plan">
		<div class="pricing_plan_header">
			<h1 class="pricing_plan_title">Basic Plan 1.5GB</h1>
	
		</div>
		
		<div class="pricing_plan_action">
		<p class="pricing_plan_cost">PLAN: &#x20b9; 209</p>
		<p class="pricing_plan_txt"> VALIDITY: 28 days</p>
		<p class="pricing_plan_txt">Data: 1.5GB/day</p>
	<a  href="${pageContext.request.contextPath}/view/paymentprepaid.jsp" class="pricing_plan_button">Purchase</a>
		</div>
		<div class="pricing_plan_descrp">
			<ul class="pricing_plan_list">
	...
	<section class="pricing_plan">
		<div class="pricing_plan_header">
			<h1 class="pricing_plan_title">Basic Plan 2GB</h1>

		</div>
		
		<div class="pricing_plan_action">
		<p class="pricing_plan_cost">PLAN: &#x20b9; 259</p>
		<p class="pricing_plan_txt"> VALIDITY: 28 days</p>
		<p class="pricing_plan_txt">Data: 2GB/day</p>
<a  href="${pageContext.request.contextPath}/view/paymentprepaid.jsp" class="pricing_plan_button">Purchase</a>
		</div>
		<div class="pricing_plan_descrp">
			<ul class="pricing_plan_list">
	...
	<section class="pricing_plan">
		<div class="pricing_plan_header">
			<h1 class="pricing_plan_title">Basic Plan 2.5GB</h1>
			
		</div>
		
		<div class="pricing_plan_action">
		<p class="pricing_plan_cost">PLAN: &#x20b9; 319</p>
		<p class="pricing_plan_txt"> VALIDITY: 28 days</p>
		<p class="pricing_plan_txt">Data: 2.5GB/day</p>
	<a href="${pageContext.request.contextPath}/view/paymentprepaid.jsp" class="pricing_plan_button">Purchase</a>
		</div>
		<div class="pricing_plan_descrp">
			<ul class="pricing_plan_list">
...
<section class="pricing_plan">
		<div class="pricing_plan_header">
			<h1 class="pricing_plan_title">Best Selling Pack</h1>
			
		</div>
		
		<div class="pricing_plan_action">
		<p class="pricing_plan_cost">PLAN: &#x20b9; 619</p>
		<p class="pricing_plan_txt"> VALIDITY: 84 days</p>
		<p class="pricing_plan_txt">Data: 1.5GB/day</p>
	<a href="${pageContext.request.contextPath}/view/paymentprepaid.jsp" class="pricing_plan_button">Purchase</a>
		</div>
		<div class="pricing_plan_descrp">
...
<section class="pricing_plan">
		<div class="pricing_plan_header">
			<h1 class="pricing_plan_title">Best Selling Pack 2GB</h1>
			
		</div>
		
		<div class="pricing_plan_action">
		<p class="pricing_plan_cost">PLAN: &#x20b9; 699</p>
		<p class="pricing_plan_txt"> VALIDITY: 84 days</p>
		<p class="pricing_plan_txt">Data: 2GB/day</p>
		<a href="${pageContext.request.contextPath}/view/paymentprepaid.jsp" class="pricing_plan_button">Purchase</a>
		</div>
	...
	<section class="pricing_plan">
		...
		<div class="pricing_plan_action">
		<p class="pricing_plan_cost">PLAN: &#x20b9; 2779</p>
