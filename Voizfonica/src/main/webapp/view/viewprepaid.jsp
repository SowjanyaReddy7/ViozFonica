...
<body>
<h1 align="center">Prepaid Transaction List</h1>
...
<tr>
  ...
  <th>Page No :
<c:forEach var="count" items="${getpost14}"  varStatus="theCount">
<a align="right" href="/springexample/viewPrepaid/${theCount.count}">${theCount.count}</a>  
</c:forEach>  
</th>
