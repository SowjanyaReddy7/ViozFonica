...
<body>
<h1 align="center">QueryReport</h1>
...
<a align="right" href="/springexample/viewReport/${theCount.count}">${theCount.count}</a>  
</c:forEach>  
</th>
...
<tr><th>Number</th><th>Email</th><th>Name</th><th>Query</th>
